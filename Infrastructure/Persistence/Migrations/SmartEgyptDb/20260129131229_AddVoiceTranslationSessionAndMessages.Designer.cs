...
namespace Persistence.Migrations.SmartEgyptDb
{
    ...
    [Migration("20260129131229_AddVoiceTranslationSessionAndMessages")]
    partial class AddVoiceTranslationSessionAndMessages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DomainLayer.Models.PlaceModule.Attraction", b =>
                {
                    b.HasOne("DomainLayer.Models.PlaceModule.Place", "Place")
                        .WithOne("Attraction")
                        .HasForeignKey("DomainLayer.Models.PlaceModule.Attraction", "AttractionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DomainLayer.Models.PlaceModule.Hotel", b =>
                {
                    b.HasOne("DomainLayer.Models.PlaceModule.Place", "Place")
                        .WithOne("Hotel")
                        .HasForeignKey("DomainLayer.Models.PlaceModule.Hotel", "HotelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DomainLayer.Models.PlaceModule.Restaurant", b =>
                {
                    b.HasOne("DomainLayer.Models.PlaceModule.Place", "Place")
                        .WithOne("Restaurant")
                        .HasForeignKey("DomainLayer.Models.PlaceModule.Restaurant", "RestaurantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
