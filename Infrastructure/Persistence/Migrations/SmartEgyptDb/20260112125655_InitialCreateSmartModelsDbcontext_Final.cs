...
{
    /// <inheritdoc />
    public partial class InitialCreateSmartModelsDbcontext_Final : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFormSubmissions", x => x.SubmissionId);
                    table.ForeignKey(
                        name: "FK_UserFormSubmissions_AppUser_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoiceTranslationSessions", x => x.SessionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttractionTickets", x => x.TicketId);
                    table.ForeignKey(
